...
final class CatchStatesCacheInvalidatorServiceTest extends TestCase
{
    public function testGetSupportedTypes(): void
    {
        $service = new CatchStatesCacheInvalidatorService($this->createStub(TagAwareAdapter::class));
