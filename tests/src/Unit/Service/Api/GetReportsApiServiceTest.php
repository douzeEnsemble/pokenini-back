...
use App\Service\Api\GetReportsApiService;
 ...
 * @internal
 */
#[CoversClass(GetReportsApiService::class)]
final class GetReportsApiServiceTest extends TestCase
{
    ...
    private function getService(): GetReportsApiService
    {
        ...
        return new GetReportsApiService(
            $logger,
            $client,
            'https://api.domain',
