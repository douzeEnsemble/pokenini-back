 ...
 * @internal
 */
#[CoversClass(GetCatchStatesApiService::class)]
final class GetCatchStatesApiServiceTest extends TestCase
{
    ...
    private function getService(): GetCatchStatesApiService
    {
        ...
        return new GetCatchStatesApiService(
            $logger,
            $client,
            'https://api.domain',
