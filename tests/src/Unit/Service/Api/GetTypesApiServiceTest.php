 ...
 * @internal
 */
#[CoversClass(GetTypesApiService::class)]
final class GetTypesApiServiceTest extends TestCase
{
    ...
    private function getService(): GetTypesApiService
    {
