 ...
 * @internal
 */
#[CoversClass(GetCollectionsApiService::class)]
final class GetCollectionsApiServiceTest extends TestCase
{
    ...
    private function getService(): GetCollectionsApiService
    {
        ...
        return new GetCollectionsApiService(
            $logger,
            $client,
            'https://api.domain',
